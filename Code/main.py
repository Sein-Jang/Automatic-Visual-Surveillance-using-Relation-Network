...
import relation_net # for relation reasoning
...
flags.DEFINE_integer(
    'train_steps', default=50000,
    help=('The number of steps to use for training. Default is 112603 steps'
          ' which is approximately 90 epochs at batch size 1024. This flag'
          ' should be adjusted according to the --train_batch_size flag.'))

flags.DEFINE_integer(
    'train_batch_size', default=64, help='Batch size for training.')

flags.DEFINE_integer(
    'eval_batch_size', default=64, help='Batch size for evaluation.')

flags.DEFINE_integer(
    'num_train_images', default=2880, help='Size of training data set.')

flags.DEFINE_integer(
    'num_eval_images', default=720, help='Size of evaluation data set.')

flags.DEFINE_integer(
    'num_label_classes', default=4, help='Number of classes, at least 2')

flags.DEFINE_integer(
    'steps_per_eval', default=100,
...
flags.DEFINE_float(
    'base_learning_rate', default=0.00025,
...
def resnet_model_fn(features, labels, mode, params):
    ...
    def relation_network(feature_maps, text_inputs, is_training=(mode == tf.estimator.ModeKeys.TRAIN)):
        return relation_net.relationnet(feature_maps, text_inputs, is_training)


    image_feature_maps = cnn_network() # feature maps from resnet
    logits = relation_network(image_feature_maps, object)
...
def main(unused_argv):
    with tf.device('/gpu:0'):
        ...
        imagenet_train, imagenet_eval = [Data_input.ImageInput(
